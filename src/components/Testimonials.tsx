...
const QuoteIcon = () => (
  <svg className="w-8 h-8 text-[#FF634E] opacity-50" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-neutral-100">
                ...
                <div className="ml-auto flex items-center gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-4 h-4 text-[#FF634E]" fill="currentColor" viewBox="0 0 20 20">
